...
HOOK @ $800AF520			# team color implementation
{
  	...
  	li r5, 0x0
  	lis r6, 0x8058			# previously 80455458
  	ori r6, r6, 0x5B00		# table of characters
  	subi r7, r2, 0x7130
  	rlwinm r0, r3, 4, 0, 27
  	rlwinm r8, r5, 1, 0, 30
  	lbzx r9, r7, r4
...
notGreen:
  	...
  	lis r5, 0x8058; addi r5, r5, 0x5B00	//access costume data
  	rlwinm r0, r3, 4, 22, 27		//r3 = character instance ID, used as an index
  	li r6, 0x0
  	add r5, r5, r0
  	lwz r3, 8(r5)
  	b start
...
notGreen:
 	li r27, 0x0; li r28, 0x0; li r29, 0x0; li r30, 0x0
  	lis r5, 0x8058; addi r5, r5, 0x5B00
